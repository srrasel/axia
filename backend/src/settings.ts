...
export const SETTING_DEFS: SettingMeta[] = [
  ...
  },
  {
    ...
    label: 'Support widget enabled',
    description: 'Show floating support icon and message form on the member trading pages',
    type: 'boolean',
    group: 'Support',
    defaultValue: 'true',
  },
  {
    key: 'support_icon',
    label: 'Support icon',
    description: 'Icon shown on the floating support button',
    type: 'select',
    group: 'Support',
    options: ['message-circle', 'headphones', 'life-buoy', 'help-circle', 'mail'],
    defaultValue: 'message-circle',
  },
  {
    key: 'support_form_title',
    label: 'Support form title',
    description: 'Heading shown in the support message popup',
    type: 'text',
    group: 'Support',
  ...
  },
  {
    ...
    label: 'Support form subtitle',
    description: 'Short helper text under the form title',
    type: 'text',
    group: 'Support',
    defaultValue: 'Send us a message and our team will get back to you.',
  },
  {
    key: 'support_form_placeholder',
    label: 'Message placeholder',
    description: 'Placeholder text inside the support message box',
    type: 'text',
    group: 'Support',
    defaultValue: 'How can we help you?',
  },
  {
    key: 'support_success_message',
    label: 'Success message',
    description: 'Shown after a member successfully submits a support message',
    type: 'text',
    group: 'Support',
    defaultValue: 'Your message was sent. We will reply soon.',
  },
  {
